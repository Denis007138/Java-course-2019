...
public class Main {
    public static void main(String[] args) {
        ...
        //основное дз
        User user1 = new User(4345, "Елена", "Пояркова",null, "https://avatars.mds.yandex.net/get-yapic/0/0-0/islands-middle");
        User user2=new User(2134,"Дина","Григорьева",null,"https://avatars.mds.yandex.net/get-yapic/34189/7H7lhWeiJ12kUmPME6vezOaw-1573964326/islands-middle");
        User user3=new User(2765,"Данис","Коновалов",null,"https://avatars.mds.yandex.net/get-yapic/0/0-0/islands-middle");
